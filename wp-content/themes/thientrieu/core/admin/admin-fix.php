<?php 
	...
	function custom_dashboard_help() { ?>
	    <h2>Chào mừng đến với Hệ thống Quản Trị Website Dây Giầy Thông Minh Splus</h2>
	    <p><strong>THÔNG TIN WEBSITE</strong></p>
	    <P><?php echo bloginfo( 'name' ); ?></p>
	    <p><strong>NHÀ PHÁT TRIỂN</strong></p>
	    <p>Hệ thống được edit bởi <a href="http://daygiaythongminh.vn/"><strong>Dây Giầy Thông Minh Splus</strong></a></p>
	    <p>Mọi yêu cầu, hỗ trợ quý khách hàng có thể liên hệ <strong>PHP Developers</strong></p>
	    <p><strong>Điện thoại</strong>: 092 321 3388</p> 
	    <p><strong>Email</strong>: quangnx.bg@gmail.com - <strong>Website</strong>: <a href="http://daygiaythongminh.vn/"><strong>Dây Giày Thông Minh</strong></a></p> 
	    <p><strong>Cảm ơn quý khách đã tin tưởng và sử dụng sản phẩm của daygiaythongminh.vn</strong></p>
	<?php }
